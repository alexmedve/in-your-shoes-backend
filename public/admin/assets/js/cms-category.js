/**
 * Bubbly - Bootstrap 5 Dashboard & CMS Theme v. 1.1.0
 * Homepage:
...
document.addEventListener("DOMContentLoaded", function () {
    const dataTable = new simpleDatatables.DataTable("#categoryDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function (args) {
        document.getElementById("categoryDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});
