  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-4 col-xs-12">
        <div class="alert alert-secondary" style="background-color: #C86328">
          <h1 class="text-center text-bold mb-3" style="font-size: 45px">Newsletter Subscribers</h1>
          <div class="d-flex">
          ...
          <table class="table table-hover align-middle mb-0" id="postDatatable">
            ...
            @foreach($subscribers as $subscriber)
              <tr>
                ...
                <td>{{$subscriber->newsletter ?? 'unavailable'}}</td>
